...
\begin{document}
	...
	\begin{flushleft}
		...
		\underset{\text{инициалы, фамилия}}{\underline{\text{\strut А.А. Протасов, Н.А. Соловьев}}}
		$
	\end{flushleft}
	...
	\begin{center}
		...
		\text{Семафоров 5, потоков 10}\\
		\includegraphics[scale=0.7]{200}\\
		\text{Семафоров 10, потоков 20}
	\end{center}
\end{document}